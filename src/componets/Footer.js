...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 text-white bg-slate-600 pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
        <div className="container">
          <div className="-mx-4 flex justify-center flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <a href="/#" className="mb-6 inline-block max-w-[160px]">
                <h3 className="font-bold">shivakumar</h3>
                  </a>
            ...
            <LinkGroup header="Quick Links">
              ...
              <NavLink link="/#" label="Know Me More" />
